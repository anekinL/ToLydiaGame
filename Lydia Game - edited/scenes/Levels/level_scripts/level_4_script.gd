...
@onready var next_sc = load("res://scenes/Levels/level_5.tscn")
...
func _ready():
	...
	Dialogic.start("Level4_dialogue")
	await Dialogic.timeline_ended
	$Node2D.position = $Camera2D.get_global_position()
	Dialogic.start("level4b_dialogue")
	await Dialogic.timeline_ended
